...
class PmpompaController extends Controller
{
    ...
    public function indexpm()
    {
        ...
        return view('/pmpompa.indexpm', compact('Pmpompa', 'start', 'end'));
    ...
    public function createpm()
    {
        ...
        return view('/pmpompa.createpm', compact('Equipment', 'Area'));
    }
    ...
    public function storepm(Request $request)
    {
        ...
        return redirect('/pmpompa' )->with('toast_success','Form PM Pumps Berhasil Ditambahkan');
    ...
    public function showpm(Pmpompa $pmpompa)
    {
        $Area = PublicArea::all();
        $Equipment = Equipment::all();
        return view('/pmpompa.viewpm', compact('pmpompa', 'Area', 'Equipment'));
    }
    ...
    public function editpm(Pmpompa $pmpompa)
    {
        $Area = PublicArea::all();
        $Equipment = Equipment::all();
        return view('/pmpompa.editpm', compact('pmpompa', 'Area', 'Equipment'));
         }
    ...
    public function updatepm(Request $request, Pmpompa $pmpompa)
    {
        ...
        ->update([
            ...
            return redirect('/pmpompa' )->with('toast_info','Form PM Pumps Berhasil Diupdate');
         }
    ...
    $pmpompa->delete();
    return redirect('/pmpompa' )->with('toast_warning','Form PM Pumps Berhasil Didelete');
    ...
    public function fillter(Request $request)
    {
        ...
        {
            if ($start==null) {
                $Pmpompa = Pmpompa::orderBy('created_at', 'desc')->Paginate(10);
                return view('/pmpompa.indexpm', compact('Pmpompa', 'start', 'end'));
               }
            if ($start > 0) {
                if ($end > 0) {
                    ...
                    $Pmpompa= Pmpompa::whereBetween('created_at', [$awalkaping,$tungtungkaping])->orderBy('created_at','desc')->Paginate(10);
                    return view('/pmpompa/indexpm', compact('Pmpompa','start', 'end'));
                }
                if ($end==null) {
                    $end = Carbon::now()->format('Y-m-d H:i:s');
        ...
        if ($cari != null) {
           if ($start == null) {
              if ($end == null) {
                ...
                $Pmpompa= Pmpompa::where('teknisi','like','%'.$cari.'%')
           ...
           if ($start > 0) {
              if ($end == null) {
                ...
                $awalkaping= $start.' '.$menitawal;
                $tungtungkaping=$end.' '.$menitakhir;
                $Pmpompa= Pmpompa::where('teknisi','like','%'.$cari.'%')->whereBetween('created_at', [$awalkaping,$tungtungkaping])->orderBy('created_at','desc')->Paginate(10);
               return view('/pmpompa.indexpm', compact('Pmpompa', 'start', 'end'));
              }
              if ($end > 0) {
