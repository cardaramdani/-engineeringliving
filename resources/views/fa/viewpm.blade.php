...
<tr  align="left">
  <th scope="col" colspan="5" rowspan="2" class="align-middle">EQUIPMENT : Fire Alarm <br>
...
<tr>
        ...
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
         ...
         <input type="text" class="form-control" value="{{$firealarm->teknisi}}" readonly name="teknisi" id="teknisi" >
        </div>
        </td>
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
          <div class="form-group">
