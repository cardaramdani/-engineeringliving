...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">Preventive Maintenance HYDRANT</h1>
            </div>
        ...
        <div class="panel">
            <div class="card-body">
            <!-- MULAI TABLE -->
            <table class="table table-striped table-bordered table-sm" id="table_pmhydrant">
                <thead>
                    <tr>
                ...
                <div class="modal-body">
                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                        <table class="table table-bordered table-striped" style="">
                            ...
                            <input type="hidden" name="zone_baru" id="zone_baru">
                            ...
                            <tr  align="left">
                              ...
                              Floor : <div class="form-group">
                                ...
                                Zone : <div class="form-group">
                                        <select class="custom-select" id="item_no" name="item_no" required>
                                        </select>
                                      </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filter').click(function () {
                ...
                if (from_date != '' && to_date != '') {
                    $('#table_pmhydrant').DataTable().destroy();
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("ADD PM HYDRANT"); //valuenya tambah pegawai baru
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('hydrant.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_pmhydrant').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            var data_id = $(this).data('id');
            $.get('hydrant/edit/' + data_id,
            function (data) {
                $('#modal-judul').html("UPDATE PM HYDRANT");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "hydrant/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_pmhydrant').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
...
$('#lantai').on('change',function(){
    ...
    $.ajax({
        type: 'GET',
        url: '/hydrant/type/'+lantai_id,
        success:function(data){
            console.log(data);
            var isi_data =JSON.parse(data);

            $('#item_no').empty();
            $('#item_no').append('<option value="0" disabled selected>Select zone</option>');
            isi_data.forEach(element => {
