...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">ELECTRICITY UNIT</h1>
            </div>
    ...
    <div class="panel">
        <div class="card-body">
            ...
            <!-- MULAI TABLE -->
            <table class="table table-striped table-bordered table-sm" id="table_kwhunit">
                <thead>
                    <tr>
                        <th >ACTION</th>
                        <th>UNIT</th>
...
<script src="{{URL::to('assets1/js/plugins/dataTables/dataTables.bootstrap4.min.js')}}"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filter').click(function () {
                ...
                if (from_date != '' && to_date != '') {
                    $('#table_kwhunit').DataTable().destroy();
            ...
            $('#export').click(function (e) {
                ...
                if (from_date != '' && to_date != '') {
                    $.ajax({
                        ...
                        url: "{{ route('kwhunit.export') }}", //url simpan data
                        type: "GET", //karena simpan kita pakai method POST
                        dataType: 'json',
                        complete:function(data){
                            location.href="/kwhunit/export?"+"from_date="+from_date+"&"+"to_date="+to_date;
                            }
                    });
                } else {
                    alert('Both Date is required');
            ...
            function load_data(from_date = '', to_date = '') {
                $('#table_kwhunit').DataTable({
                    processing: true,
                    serverSide: true, //aktifkan server-side
                    ajax: {
                        url: "{{ route('kwhunit.index') }}",
                        type: 'GET',
                    ...
                    columns: [
                        ...
                        //     // return "<img src={{ URL::to('/') }}/dataIMG_kwhunit/" + data + " width='70' class='img-thumbnail MagicZoom' rel='zoom-id:zoom;opacity-reverse:true;' />";
                        //     return "<a href={{  URL::to('/') }}/dataIMG_kwhunit/" + data + " width='70' title='click to ZOOM' class='MagicZoom img-thumbnail' rel='zoom-id:zoom;opacity-reverse:true;'>" +
                        //         "<img width='70' height='70' src={{ URL::to('/') }}/dataIMG_kwhunit/" + data + "></a>";
                        //     },
                        //     orderable: false
                        // },
                        @role('Admin|Fa|Eng-spv|')
        ...
        //jalankan jquery validator terhadap setiap inputan dll dan eksekusi script ajax untuk simpan data
            ...
            var oTable = $('#table_kwhunit').dataTable(); //inialisasi datatable
    ...
    //TOMBOL add DATA bulanan DAN TAMPIKAN DATA BERDASARKAN ID PEGAWAI KE MODAL
        $('body').on('click', '.add', function () {
            ...
            function (data) {
                ...
                $('#modal-judul').html("Add Monthly KWH Unit");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "kwhunit/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_kwhunit').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
                    if(data.success){
                            iziToast.success({ //tampilkan iziToast dengan notif data berhasil disimpan pada posisi kanan bawah
