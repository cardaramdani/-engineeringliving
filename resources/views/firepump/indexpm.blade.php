...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">Preventive Maintenance FIREPUMP</h1>
            </div>
        ...
        <div class="panel">
            <div class="card-body">
            <!-- MULAI TABLE -->
            <table class="table table-striped table-bordered table-sm" id="table_pmfirepump">
                <thead>
                    <tr>
                ...
                <div class="modal-body">
                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                        <table class="table table-bordered table-striped" style="">
                            ...
                            <tr  align="left">
                              <th scope="col" colspan="5" class="align-middle">EQUIPMENT : Diesel, Electric, Jockey Pump
                              </th>
                            ...
                            <tbody  class="body_tabel_firepump">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filter').click(function () {
                ...
                if (from_date != '' && to_date != '') {
                    $('#table_pmfirepump').DataTable().destroy();
            ...
            var data_id = $(this).data('id');
                var url = "/pmfirepump/pdf/"+data_id;
            ...
            $('body').on('click', '.Export-xlsx', function () {
                event.preventDefault();
            var data_id = $(this).data('id');
                var url = "/pmfirepump/xlsx/"+data_id;
                location.replace(url);
            });
            ...
            function load_data(from_date = '', to_date = '') {
                $('#table_pmfirepump').DataTable({
                    processing: true,
                    serverSide: true, //aktifkan server-side
                    ajax: {
                        url: "{{ route('pmfirepump.index') }}",
                        type: 'GET',
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("ADD PM FIREPUMP"); //valuenya tambah pegawai baru
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('pmfirepump.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_pmfirepump').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            var data_id = $(this).data('id');
            $.get('pmfirepump/edit/' + data_id,
            function (data) {
                $('#modal-judul').html("UPDATE PM FIREPUMP");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "pmfirepump/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_pmfirepump').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
