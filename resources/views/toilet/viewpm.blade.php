...
Nama Toilet : <div class="form-group">
            ...
            <option value="Toilet Pria" disabled>Toilet Pria</option>
            <option value="Toilet Wanita" disabled>Toilet Wanita</option>
            <option value="Toilet Difabel" disabled>Toilet Difabel</option>
            </select>
        </div>
  </th>
...
<tr>
        ...
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
         ...
         <input type="text" class="form-control" value="{{$toilet->teknisi}}" required name="teknisi" id="teknisi" readonly>
        </div>
        </td>
        <td scope="col" align="center" class="font-weight-bold align-middle" colspan="9">
          <div class="form-group">
