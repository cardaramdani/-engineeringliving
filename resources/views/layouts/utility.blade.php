...
<html lang="en">
  <head>
    ...
    @yield('tambahan_link')
    <link rel="stylesheet" href="{{asset('/assets/css/Sidebar_submenu-utility/style.css')}}">
        ...
        <div class="header-c">
          <div class="judul-menu">
            ...
            <ul>
              <!--search box start-->
@role('Admin|Eng-spv|')
              <form class="search-box" action="@yield('action-search')" method="post">
                @csrf
...
@endrole
              ...
              <!-- <form id="ac-add-form" action="@yield('action-add')" method="get" style="display: none;">
                  @csrf
              </form> -->
@role('Admin|Eng-spv|')
              <li>
