...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">ROOMS</h1>
            </div>
        ...
        <div class="panel">
            <div class="card-body">
            <!-- MULAI TABLE -->
            <table class="table table-striped table-bordered table-sm" id="table_room">
                <thead>
                    <tr>
                        <th class="align-center">NAME</th>
                        <th class="align-center">FLOOR</th>
                        <th class="align-center">TOWER</th>
                        @role('Admin|Eng-spv|')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function load_data(tower_change) {
                $('#table_room').DataTable({
                    ...
                    columns: [
                        {data: 'name',name: 'name'},
                        {data: 'floor', name: 'floor_id'},
                        {data:'tower', name: 'tower_id'},
                        @role('Admin|Eng-spv|')
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('rooms.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_room').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('rooms/edit/' + data_id,
            function (data) {
                $('#modal-judul').html("UPDATE ROOM");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "rooms/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    ...
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_room').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
