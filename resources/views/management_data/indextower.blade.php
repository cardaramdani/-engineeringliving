...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">Towers</h1>
            </div>
        ...
        <div class="panel">
            <div class="card-body">
            <!-- MULAI TABLE -->
            <table class="table table-striped table-bordered table-sm" id="table_towers">
                <thead>
                    <tr>
                ...
                <div class="modal-body">
                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                        <table class="table table-bordered table-striped" style="">
                            ...
                            <input type="hidden" name="tower_type_baru" id="tower_type_baru">
                            <div class="form-group was-validated">
                                <input type="text" class="form-control" placeholder="Nama Tower" id="tower" name="tower" required autocomplete="off">
                                 <div class="invalid-feedback">input data sesuai aktual</div>
                               </div>

                               <div class="form-group was-validated">
                                 <select class="custom-select" id="tower_type" name="tower_type" required>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filter').click(function () {
                ...
                if (from_date != '' && to_date != '') {
                    $('#table_towers').DataTable().destroy();
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("ADD TOWER"); //valuenya tambah pegawai baru
            $('#tambah-edit-modal').modal('show'); //modal tampil
            $('#tower_type').empty();
            $('#tower_type').append(`<option value="${data['tower_type']}">${data['tower_type']}</option><option value="Residence">Residence</option><option value="Office strata">Office strata</option><option value="Office leaseing">Office leaseing</option><option value="Comersial">Comersial</option>`);
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('towers.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_towers').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('towers/edit/' + data_id,
            function (data) {
                $('#modal-judul').html("UPDATE TOWER");
            ...
            //set value masing-masing id berdasarkan data yg diperoleh dari ajax get request diatas
                ...
                $('#type_tower_baru').val(data.type_tower);
                $('#tower_type').append(`<option value="${data['tower_type']}">${data['tower_type']}</option><option value="Residence">Residence</option><option value="Office strata">Office strata</option><option value="Office leaseing">Office leaseing</option><option value="Comersial">Comersial</option>`);
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "towers/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_towers').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
