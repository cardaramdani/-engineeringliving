...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">PAM</h1>
            </div>
        ...
        <div class="card-body">
                <!-- MULAI TABLE -->
                <table class="table table-striped table-bordered table-sm" id="table_pdam">
                    <thead>
                        <tr>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group was-validated">
                                    ...
                                    <input id="stand" type="number" class="form-control @error('stand') is-invalid @enderror" placeholder="stand" name="stand" required autocomplete="off" value="{{ old('stand') }}">
                                    <div class="invalid-feedback">input data sesuai aktual</div>
                                  </div>
    ...
    <script>
            ...
            $('#export').click(function (e) {
                ...
                if (from_date != '' && to_date != '') {
                    $.ajax({
                        ...
                        url: "{{ route('pdam.export') }}", //url simpan data
                        type: "GET", //karena simpan kita pakai method POST
                        dataType: 'json',

                        complete:function(data){
                            location.href="/pdam/export?"+"from_date="+from_date+"&"+"to_date="+to_date;
                            }
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("Add PDAM"); //valuenya tambah pegawai baru
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('pdam.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_pdam').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('pdam/edit/' + data_id, function (data) {
                $('#modal-judul').html("UPDATE PDAM");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "pdam/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_pdam').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
