...
<thead class="thead-dark" align="center">
        ...
        <tr>
          ...
          <th scope="col" align="center" class="align-middle" colspan="7" style="background-color: gray">{{$pmgondola->created_at}}</th>
...
<tr>
    ...
    <td scope="col" align="center" class="font-weight-bold" colspan="9">Dikerjakan oleh : {{$pmgondola->teknisi}}</td>
