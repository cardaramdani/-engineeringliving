...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">Preventive Maintenance GONDOLA</h1>
            </div>
        ...
        <div class="panel">
            <div class="card-body">
            <!-- MULAI TABLE -->
            <table class="table table-striped table-bordered table-sm" id="table_pmgondola">
                <thead>
                    <tr>
                ...
                <div class="modal-body">
                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                        <table class="table table-bordered table-striped" style="">
                            ...
                            <input type="hidden" name="teknisi" id="teknisi">
                                ...
                                <thead class="thead-dark" align="center">
                                    ...
                                    <th scope="col" align="center" class="align-middle" colspan="7">
                                        <div class="form-group">
                                        <input style="color: black;" type="date" class="form-control" name="planpm" id="planpm" required>
                                        </div>
                                    </th>
                            ...
                            <tbody style="display: none;" class="body_tabel_pmgondola">
                                <tr id="header_list" style="font-size:20px; background-color: #1f1f1ef0; color:#1ab394;">
                                    <td scope="col" align="left" colspan="19" class="font-weight-bold"></td>

                            </tr>
                            <tr class="body_pmgondola_bulanan" style=" display:none;background-color: #1f1f1ef0; color:#1ab394;">
                            ...
                            <tr class="body_cwt_3bulanan" style=" display:none;background-color: #1f1f1ef0; color:#1ab394;">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#filter').click(function () {
                ...
                if (from_date != '' && to_date != '') {
                    $('#table_pmgondola').DataTable().destroy();
            ...
            function load_data(from_date = '', to_date = '') {
                $('#table_pmgondola').DataTable({
                    processing: true,
                    serverSide: true, //aktifkan server-side
                    ajax: {
                        url: "{{ route('gondola.index') }}",
                        type: 'GET',
        ...
        $('#tombol-tambah').click(function () {
            ...
            $('#modal-judul').html("ADD PM GONDOLA"); //valuenya tambah pegawai baru
            $('#tambah-edit-modal').modal('show'); //modal tampil
            $('.body_tabel_pmgondola').hide();
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('gondola.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_pmgondola').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            var data_id = $(this).data('id');
            $.get('gondola/edit/' + data_id,
            function (data) {
                $('#modal-judul').html("UPDATE PM GONDOLA");
                $('#btn-name').html("update"); //valuenya tambah
                $('#tombol-simpan').val("edit-post");
                $('#tambah-edit-modal').modal('show');
                $('.body_tabel_pmgondola').show();
                $('.body_cwt_3bulanan').show()
                $('.body_pmgondola_bulanan').show()
                if (data.jadwalpm === "Bulanan") {
                $('#header_list').html("Bulanan"); //valuenya tambah pegawai baru
                }
                if (data.jadwalpm === "3 Bulanan") {
                $('#header_list').html("3 Bulanan"); //valuenya tambah pegawai baru
                }
                if (data.jadwalpm === "Tahunan") {
                $('#header_list').html("Tahunan"); //valuenya tambah pegawai baru
                }
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "gondola/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_pmgondola').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
    ...
    if (data_jadwal === "Bulanan") {
        $('#header_list').html("Bulanan"); //valuenya tambah pegawai baru
        $('.body_tabel_pmgondola').show();
        $('.body_pmgondola_bulanan').show()
        $('.body_cwt_3bulanan').hide()
        $('#l1').empty();
        $('#l2').empty();
        $('#l3').empty();
        $('#l4').empty();
        ...
        $('#l18').empty();
            ...
            $('#l16').append(valuelist);
            $('#l17').append(valuelist);
            $('#l18').append(valuelist);

    }if (data_jadwal === "3 Bulanan"){
        $('#header_list').html("3 Bulanan"); //valuenya tambah pegawai baru

        $('.body_tabel_pmgondola').show();
        $('.body_pmgondola_bulanan').hide()
        $('.body_cwt_3bulanan').show()
        $('#l1').empty();
        $('#l2').empty();
        $('#l3').empty();
