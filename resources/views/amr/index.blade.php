...
@section('tambahan_link')
    ...
    <div class="panel">
        <div class="row">
            <div class="col-md-8">
                <h1 style="font-weight: bold; margin-left: 15px;">AUTOMATIC METER READING PLN</h1>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group was-validated">
                                    ...
                                    <input id="lwbp" type="number" class="form-control @error('lwbp') is-invalid @enderror" placeholder="lwbp" name="lwbp" required autocomplete="off" value="{{ old('lwbp') }}">
                                    <div class="invalid-feedback">input data sesuai aktual</div>
                                </div>

                                <div class="form-group was-validated">
                                    <label for="wbp">Wbp</label>
                                    <input id="wbp" type="number" class="form-control @error('wbp') is-invalid @enderror" placeholder="wbp" name="wbp" required autocomplete="off" value="{{ old('wbp') }}">
                                    <div class="invalid-feedback">input data sesuai aktual</div>
                                </div>

                                <div class="form-group was-validated">
                                    <label for="kvarh">KvarH</label>
                                    <input id="kvarh" type="number" class="form-control @error('kvarh') is-invalid @enderror" placeholder="kvarh" name="kvarh" required autocomplete="off" value="{{ old('kvarh') }}">
                                    <div class="invalid-feedback">input data sesuai aktual</div>
                                </div>

                                <div class="form-group was-validated">
                                    <label for="cosp">CosP</label>
                                    <input id="cosp" type="number" class="form-control @error('cosp') is-invalid @enderror" placeholder="cosp" name="cosp" required autocomplete="off" value="{{ old('cosp') }}">
                                    <div class="invalid-feedback">input data sesuai aktual</div>
                                </div>

                                <div class="form-group was-validated">
                                    <label for="penalty">Penalty</label>
                                    <input id="penalty" type="number" class="form-control @error('penalty') is-invalid @enderror" placeholder="penalty" name="penalty" required autocomplete="off" value="{{ old('penalty') }}">
                                    <div class="invalid-feedback">input data sesuai aktual</div>
                                </div>
    ...
    <script>
            ...
            $('#export').click(function (e) {
                ...
                if (from_date != '' && to_date != '') {
                    $.ajax({
                        ...
                        url: "{{ route('amr.export') }}", //url simpan data
                        type: "GET", //karena simpan kita pakai method POST
                        dataType: 'json',

                        complete:function(data){
                            location.href="/amr/export?"+"from_date="+from_date+"&"+"to_date="+to_date;
                            }
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('amr.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_amr').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('amr/edit/' + data_id,
            function (data) {
                $('#modal-judul').html("UPDATE AMR");
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                url: "amr/delete/" + dataId, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
                ...
                success: function (data) { //jika sukses
                    setTimeout(function () {
                        ...
                        var oTable = $('#table_amr').dataTable();
                        oTable.fnDraw(false); //reset datatable
                    });
